...
---
  ...
  Today, I found an arxived paper  titled "Bayesian Variable Selection for Ultrahigh-dimensional Sparse Linear Models". This paper is about a relation between the choice of the prior and Bayesian model selection consistency. 
