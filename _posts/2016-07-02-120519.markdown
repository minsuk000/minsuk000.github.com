...
The resulting estimators have explicit forms as 
...
Figure 1 illustrates the above estimators according to varying $$\bar y$$.

#### Figure 1: the sample mean $$\bar y$$ versus the penalized estimators $$\widehat \theta$$: $$L_0$$ penalized estimator (left), $$L_1$$ penalized estimator (middle), and $$L_2$$ penalized estimator (right).{#figure1}
